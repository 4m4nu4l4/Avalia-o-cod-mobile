    ...
    <View style={{ ...styles.container, ...fundo.container }}>
      ...
      <Card style={{ width: "18rem" }}>
        <Card.Body>
          ...
          <Card.Text>oii</Card.Text>
          <Button href="https://www.vans.com.br/c/classiccarryover?q=:creation-time&page=0">
            Catalogo
          </Button>
        </Card.Body>
      </Card>
